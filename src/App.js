    ...
    <div className={css.container}>
      ...
      >
        ...
        <div className={css.headerSection}>
          <span className={css.styledHeaderText}>COMMING SOON</span>
          <span className={css.headerTextTitle}>THE CYBERHIPPOZ PROJECT</span>
          <span className={css.headerTextTitle}>(HIP)</span>
          <span className={css.headerTextSubTitle}>
            A collection of <span>10,000 highly advanced hippos </span>, from
            the <br />
            digital planet Potomia, living on the ethereum blockchain
          </span>
        </div>
        <div className={css.aboutsection}>
          <div className={css.aboutText}>WELCOME TO POTOMIA.</div>
